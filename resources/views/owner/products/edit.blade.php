                    ...
                    <form method="post" action="{{ route('owner.products.update', ['product' => $product->id]) }}" >
                        ...
                        <div class="-m-2">
                          <div class="p-2 w-1/2 mx-auto">
                            ...
                            <x-select-image :images="$images" currentId="{{ $product->image1}}" curentImage="{{ $product->imageFirst->filename ?? '' }}" name="image1" />
                            <x-select-image :images="$images" currentId="{{ $product->image2}}" curentImage="{{ $product->imageSecond->filename ?? '' }}"  name="image2" />
                            <x-select-image :images="$images" currentId="{{ $product->image3}}" curentImage="{{ $product->imageThird->filename ?? '' }}"  name="image3" />
                            <x-select-image :images="$images" currentId="{{ $product->image4}}" curentImage="{{ $product->imageFourth->filename ?? '' }}"  name="image4" />
